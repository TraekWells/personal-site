<template>
  <nav class="navigation">
    ...
    <ul class="navigation__list">
      ...
      <li class="navigation__item">
        <nuxt-link to="/blog/impossible-list" class="navigation__link"
          >Impossible List</nuxt-link
        >
      </li>
      <li class="navigation__item">
        <nuxt-link to="/about-me" class="navigation__link">About Me</nuxt-link>
      </li>
      <li class="navigation__item">
        <nuxt-link to="/contact-me" class="navigation__link"
