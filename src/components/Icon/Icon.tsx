...
const Icon = ({ type, className }: IconProps) => {
  switch (type) {
    ...
    case "settings":
      return (
        <IconWrapper className={className}>
          <g transform="translate(3.938 3)">
            <g fill="currentColor">
              <path d="M15.31 9.13l-.01-.14c0-.31.09-.6.27-.85l.76-1.05c.58-.82.68-1.88.26-2.78l-.1-.18c-.56-.97-1.6-1.5-2.68-1.39l-1.29.13c-.26.02-.52-.02-.76-.13l-.15-.08c-.23-.14-.44-.37-.56-.65L10.51.82C10.1-.1 9.22-.72 8.22-.8L8-.81c-1.09 0-2.07.63-2.51 1.62l-.53 1.18c-.11.24-.28.45-.5.6l-.13.07c-.24.13-.55.19-.85.16l-1.3-.14C1.17 2.57.2 3.02-.37 3.85l-.1.15c-.56.96-.5 2.13.14 3l.76 1.04c.15.2.24.45.26.71l0 .16c-.01.26-.1.56-.28.81l-.77 1.04c-.59.81-.69 1.87-.27 2.77l.09.17c.55.96 1.59 1.49 2.67 1.38l1.28-.14c.25-.03.51.01.75.12l.14.07c.23.13.44.36.56.64l.52 1.18c.4.92 1.28 1.54 2.29 1.61l.18 0c1.11 0 2.09-.64 2.53-1.63l.52-1.19c.1-.24.27-.45.49-.6l.12-.08c.23-.14.54-.21.84-.17l1.28.13c1 .1 1.97-.35 2.54-1.18l.09-.16c.55-.97.49-2.14-.15-3.01l-.77-1.05c-.16-.21-.25-.46-.27-.72ZM7.92.75l.12-.01 .13 0c.42.03.82.31 1 .73l.53 1.18c.24.56.67 1.03 1.2 1.34l.2.1c.51.23 1.04.32 1.57.27l1.28-.14c.48-.06.95.18 1.2.61l.06.12c.17.38.13.86-.14 1.22l-.77 1.04c-.37.5-.57 1.1-.57 1.72l0 .22c.04.56.23 1.07.54 1.5l.76 1.04c.28.39.31.92.07 1.35l-.07.1c-.25.34-.69.55-1.14.5l-1.29-.14c-.62-.07-1.24.06-1.78.37l-.18.1c-.47.32-.82.74-1.04 1.23l-.53 1.18c-.2.44-.65.73-1.14.73l-.13-.01c-.43-.04-.83-.32-1.01-.74l-.53-1.19c-.26-.57-.68-1.04-1.22-1.35l-.21-.11c-.52-.24-1.05-.33-1.58-.28l-1.29.13c-.49.05-.96-.19-1.21-.62l-.07-.13c-.18-.39-.14-.87.13-1.23l.76-1.05c.36-.51.56-1.11.56-1.73l-.01-.24c-.05-.57-.24-1.07-.56-1.5L.79 6.01C.5 5.61.47 5.08.71 4.65l.06-.11c.24-.35.68-.56 1.13-.51l1.29.13c.61.06 1.23-.07 1.77-.38l.17-.11c.46-.33.81-.75 1.03-1.25l.52-1.19c.18-.41.56-.69 1-.74Z" />
              <path d="M8.06 5.6c-1.88 0-3.4 1.52-3.4 3.39s1.52 3.39 3.39 3.39 3.39-1.53 3.39-3.4c0-1.88-1.53-3.4-3.4-3.4Zm0 1.5c1.04 0 1.89.84 1.89 1.89 0 1.04-.85 1.89-1.9 1.89 -1.05 0-1.9-.85-1.9-1.9 0-1.05.84-1.9 1.89-1.9Z" />
            </g>
          </g>
