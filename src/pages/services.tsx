...
const Services = () => {
  return (
    <>
      <NextSeo
        title="Services"
        description="I offer web design and web development services to small businesses that want to build or expand their online presence."
        openGraph={{
          url: "https://www.traekwells.com/services",
        }}
        canonical="https://www.traekwells.com/services"
      />
