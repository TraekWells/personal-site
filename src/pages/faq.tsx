...
const FAQ = () => {
  return (
    <>
      <NextSeo
        title="FAQ"
        description="As a client, you might have some questions that a lot of other people have as well. I've compiled this list of questions and I've answered them to clear up any confusion."
        openGraph={{
          url: "https://www.traekwells.com/faq",
        }}
        canonical="https://www.traekwells.com/faq"
      />
