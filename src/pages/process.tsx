...
const Process = () => {
  return (
    <>
      <NextSeo
        title="Process"
        description="This lays out the step by step process from starting with an email to me, all the way to launching the finished project and celebrating. The goal of this page is to clear up any confusion on what to expect during the process."
        openGraph={{
          url: "https://www.traekwells.com/process",
        }}
        canonical="https://www.traekwells.com/process"
      />
