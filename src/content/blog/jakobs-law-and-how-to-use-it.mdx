...
<Note type="info">
  A mental model is what we think we know about a system, specifically how it
  works.
</Note>
...
![Runner's World navigation](/images/runners-world-navigation.png "Runner's World navigation example")

![Pocket navigation](/images/pocket-navigation.png "Pocket navigation example")

![CSS Tricks navigation](/images/css-tricks-navigation.png "CSS Tricks navigation example")
...
![Uncommon CSS Tricks navigation](/images/weird-layout.jpg "Uncommon CSS Tricks navigation example")
