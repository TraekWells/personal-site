...
<Note>
  This is not an anti-WordPress post. In fact, I think WordPress is a fantastic
  tool and depending on the needs of the project, could be the perfect solution.
  This post is simply to promote how amazing Forestry is.
</Note>
...
![](/images/forestry-add-site.png)

Select a static site generator

![](/images/forestry-select-ssg.png)

Select your Git provider

![](/images/forestry-select-git-provider.png)

Select your Git repository

![](/images/forestry-link-repo.png)
...
![Forestry editing experience](/images/forestry-editing-experience.png "Forestry editing experience")
